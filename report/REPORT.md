...
| erase된 블록 수 | 85,631 | **89,440** | 86,507 |
...
**Cost-Benefit은 총 migration 비용을 Greedy보다 13.6% 더 쓰지만(latency도 약 5% 높지만), 블록 하나의 최대 erase 횟수는 더 낮고(8.3 vs 10.3), 마모를 더 많은 블록에 분산시킨다.** 이는 Cost-Benefit GC가 이론적으로 의도하는 트레이드오프 — 전체 효율을 다소 희생하는 대신 특정 블록에 마모가 집중되는 것을 막아 SSD 수명을 고르게 소모시킴 — 와 정확히 일치하는 결과다.
