...
위 표의 두 열을 나란히 보면 이 실험에서 가장 인상적인 대목이 나온다. Cost-Benefit은 7.21페이지짜리 line을 고를 수 있는데도 **일부러 17.04페이지짜리를 골랐다** — 그 순간의 최선보다 2.4배 비싼 선택이다. 그런데도 매번 자기 기준의 최선을 고른 Greedy의 실제 비용(24.66)보다 여전히 싸다. **눈앞의 최적을 포기한 정책이, 매번 최적을 고른 정책보다 결과적으로 더 적게 옮긴 것이다.** 국소적으로 최적인 선택이 전역적으로는 최적이 아니라는, Cost-Benefit이 애초에 겨냥한 문제가 그대로 드러난 셈이다.
