...
```bash
NVME_DEV=$NVME_DEV MEMMAP_START=$MEMMAP_START MEMMAP_SIZE=$MEMMAP_SIZE NVME_CPUS=$NVME_CPUS \
RANDOM_DIST=zipf:1.2 NORANDOMMAP=1 UNIFORM_SIZE=600M UNIFORM_LOOPS=10 TLC_GC_POLICY=0 SLC_CACHE_RATIO_PERCENT=10 \
./scripts/run_experiment.sh 0 zipf_nrm_server_rep1 uniform

NVME_DEV=$NVME_DEV MEMMAP_START=$MEMMAP_START MEMMAP_SIZE=$MEMMAP_SIZE NVME_CPUS=$NVME_CPUS \
RANDOM_DIST=zipf:1.2 NORANDOMMAP=1 UNIFORM_SIZE=600M UNIFORM_LOOPS=10 TLC_GC_POLICY=0 SLC_CACHE_RATIO_PERCENT=10 \
./scripts/run_experiment.sh 1 zipf_nrm_server_rep1 uniform

NVME_DEV=$NVME_DEV MEMMAP_START=$MEMMAP_START MEMMAP_SIZE=$MEMMAP_SIZE NVME_CPUS=$NVME_CPUS \
RANDOM_DIST=zipf:1.2 NORANDOMMAP=1 UNIFORM_SIZE=600M UNIFORM_LOOPS=10 TLC_GC_POLICY=0 SLC_CACHE_RATIO_PERCENT=10 \
./scripts/run_experiment.sh 2 zipf_nrm_server_rep1 uniform

NVME_DEV=$NVME_DEV MEMMAP_START=$MEMMAP_START MEMMAP_SIZE=$MEMMAP_SIZE NVME_CPUS=$NVME_CPUS \
RANDOM_DIST=zipf:1.2 NORANDOMMAP=1 UNIFORM_SIZE=600M UNIFORM_LOOPS=10 TLC_GC_POLICY=0 SLC_CACHE_RATIO_PERCENT=10 \
./scripts/run_experiment.sh 3 zipf_nrm_server_rep1 uniform
```
...
```bash
NVME_DEV=$NVME_DEV MEMMAP_START=$MEMMAP_START MEMMAP_SIZE=$MEMMAP_SIZE NVME_CPUS=$NVME_CPUS \
COLD_SIZE=512M COLD_TOUCH_SIZE=256M HOT_SIZE=64M HOTCOLD_RUNTIME=60 TLC_GC_POLICY=0 SLC_CACHE_RATIO_PERCENT=10 \
./scripts/run_experiment.sh 0 hotcold_server_rep1 hotcold

NVME_DEV=$NVME_DEV MEMMAP_START=$MEMMAP_START MEMMAP_SIZE=$MEMMAP_SIZE NVME_CPUS=$NVME_CPUS \
COLD_SIZE=512M COLD_TOUCH_SIZE=256M HOT_SIZE=64M HOTCOLD_RUNTIME=60 TLC_GC_POLICY=0 SLC_CACHE_RATIO_PERCENT=10 \
./scripts/run_experiment.sh 1 hotcold_server_rep1 hotcold

NVME_DEV=$NVME_DEV MEMMAP_START=$MEMMAP_START MEMMAP_SIZE=$MEMMAP_SIZE NVME_CPUS=$NVME_CPUS \
COLD_SIZE=512M COLD_TOUCH_SIZE=256M HOT_SIZE=64M HOTCOLD_RUNTIME=60 TLC_GC_POLICY=0 SLC_CACHE_RATIO_PERCENT=10 \
./scripts/run_experiment.sh 2 hotcold_server_rep1 hotcold

NVME_DEV=$NVME_DEV MEMMAP_START=$MEMMAP_START MEMMAP_SIZE=$MEMMAP_SIZE NVME_CPUS=$NVME_CPUS \
COLD_SIZE=512M COLD_TOUCH_SIZE=256M HOT_SIZE=64M HOTCOLD_RUNTIME=60 TLC_GC_POLICY=0 SLC_CACHE_RATIO_PERCENT=10 \
./scripts/run_experiment.sh 3 hotcold_server_rep1 hotcold
```
